...
namespace Skill.Editor.Curve
{
    public class CurveKey : CanvasPanel, Skill.Editor.UI.IProperties, Skill.Editor.UI.ISelectable
    {
        ...
        void _DragThumb_MouseDown(object sender, MouseClickEventArgs args)
        {
            ...
            {
                if ((args.Shift || args.Cmd) && !Track.View.Editor.Selection.Contains(this))
        ...
        {
           get { return Keyframe.inTangent * Mathf.Rad2Deg; }
           set
           {
               Keyframe k = this.Keyframe;
               k.inTangent = value * Mathf.Deg2Rad;
               this.Keyframe = k;
           }
        }
        ...
        {
           get { return Keyframe.outTangent * Mathf.Rad2Deg; }
           set
           {
               Keyframe k = this.Keyframe;
               k.outTangent = value * Mathf.Deg2Rad;
               this.Keyframe = k;
           }
        }
