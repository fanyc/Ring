...
namespace Skill.Editor.Curve
{
    public class CurveTrack : CanvasPanel
    {
        ...
        public bool IsLocked
        {
            ...
            set
            {
                if(_isLocked != value)
                {
                    ...
                    {
                        ((CurveKey)Controls[i]).IsSelectable = !_isLocked;
                    }
                }
            }
        }
        ...
        protected List<int> _RemovingKeys = new List<int>();
        ...
        protected float GetTime(float x, bool relative, ref Rect renderArea)
        {
        ...
        protected float GetValue(float y, bool relative, ref Rect renderArea)
        {
